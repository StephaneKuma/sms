    ...
    <div class="content-header">
        ...
        <div class="content-header-section">
            ...
            @auth
                ...
                @else
                    <a class="btn btn-rounded btn-dual-secondary text-danger"
                        href="{{ route('settings.sections.create') }}">
        ...
        <div class="content-header content-header-fullrow">
            <form action="#" method="post">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="Rechercher ou taper ESC.."
