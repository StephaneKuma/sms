                                ...
                                <td class="text-center">
                                    <form action="{{ route('settings.acl.users.destroy', $user) }}" method="POST">
                                        ...
                                        <div class="btn-group" user="group">
                                            <a href="{{ route('settings.acl.users.edit', $user) }}" class="btn btn-sm btn-outline-info" data-toggle="tooltip" title="Modifier l'utilisateur">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <a onclick="event.preventDefault(); this.closest('form').submit();" class="btn btn-sm btn-outline-danger" data-toggle="tooltip" title="Supprimer l'utilisateur">
